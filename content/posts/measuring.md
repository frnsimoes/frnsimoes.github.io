...
Run it a few times. m = 0 doesn't always lose - sometimes instinct picks the right machine and you look like a genius over 100 rounds. Instinct can be right, sometimes, the problem is you have no way to find out when it isn't, and regret accumulates invisibly. Measurement, on the other hand, doesn't guarantee you're right, but it guarantees you can be shown wrong.
...
UCB works because there's a *bonus* for exploring the less known options. 
