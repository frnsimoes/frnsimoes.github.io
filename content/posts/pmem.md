...
I encountered another production mystery - a Node.js app was consuming 665 MiB of memory. I didn't know where it was coming from, so I started by looking at `process.memoryUsage()`:
