...
One of my machines (32GB RAM and 8vCPUs) was hitting 90% of CPU usage. A few containers running, no alerts. 

I ssh'ed and found a process with cmd `bash startup.sh` that had been running for 28 minutes.
